...
import { Cloud, Building2, User, Mail } from 'lucide-react';
...
const Auth = () => {
  ...
  // Update profile with account type after successful auth
  useEffect(() => {
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="glass-card border-white/10">
          <CardHeader className="text-center pb-3">
            <CardTitle className="text-foreground text-lg">Account Type</CardTitle>
          </CardHeader>
          <CardContent>
